<template>
    <div class="container" :class="{container_collapse:collapse}">
            ...
            <div class="set_info">
                ...
                <div class="order_table">
                    <el-table :data="list" border style="width: 100%">
                        <el-table-column prop="pidName" label="色系" min-width="18%">
                        </el-table-column>
                        <el-table-column prop="name" label="颜色名称" min-width="18%">
                        </el-table-column>
                        <el-table-column prop="sn" label="颜色编号" min-width="18%">
                        </el-table-column>
        ...
        <el-dialog title="色系" :visible.sync="oldMenu">
        ...
        <el-dialog class="importExport" title="导入" :visible.sync="importbox" width="30%" :showClose="false" :show-file-list="false">
            <a class="down" href="/TPA/aYscm/downExcelColor">下载导入模板</a>
...
export default {
    ...
    methods: {
        ...
        uploadFile(params) {
            ...
            if (this.fugai) {
                this.$ajax
                    .post("/TPA/aYscm/importExcelColor?isCover=true", formData)
                    .then(res => {
                        console.log(res);
                        if (res.status === 200) {
                            if (res.data.code === 0) {
                ...
                this.$ajax
                    .post("/TPA/aYscm/importExcelColor?isCover=false", formData)
                    .then(res => {
                        if (res.status === 200) {
                            if (res.data.code === 0) {
                                succ(res.data.msg);
        ...
        //导出按钮
        doExports() {
            window.location.href = "/TPA/aYscm/exportExcelColor";
        },
        ...
        addSave() {
            ...
            if (this.form.sn.length === 0) {
                ...
                if (this.addEdit) {
                    this.$http
                        .post("/TPA/aYscm/insertColor", qs.stringify(this.form))
                        .then(res => {
                    ...
                    this.$http
                        .post("/TPA/aYscm/updateColor", qs.stringify(this.form))
                        .then(res => {
                            if (res.data.code === 0) {
                                succ(res.data.msg);
                                console.log(res);
        ...
        doEffectives() {
            ...
            this.$http
                .post("/TPA/aYscm/statusColor", qs.stringify(params))
                .then(res => {
                    if (res.data.code === 0) {
        ...
        handleNodeClick(data,node,item){
            this.pageOnOff = false;
                ...
                this.pageParams = params;
                this.$http
                    .post("/TPA/aYscm/searchColor", qs.stringify(params))
                    .then(res => {
                        if (res.data.code === 0) {
                            this.list = res.data.data.list;
                            this.total = res.data.data.total;
        ...
        saveEdit() {
            if (this.forms.name.length === 0) {
                ...
                if (this.forms.sort.trim() == "") {
                    this.forms.sort = 0;
                }
                this.$http
                    .post("/TPA/aYscm/updateColor", qs.stringify(this.forms))
                    .then(res => {
                        console.log(res);
        ...
        effective(index, row) {
            ...
            this.forms.status = 1;
            this.$http
                .post("/TPA/aYscm/statusColor", qs.stringify(this.forms))
                .then(res => {
                    if (res.data.code === 0) {
                        succ(res.data.msg);
                        this.$set(this.list, this.idx, this.forms);
    ...
    watch: {
        page() {
            ...
            this.$http
                .post("/TPA/aYscm/searchColor", qs.stringify(this.pageParams))
                .then(res => {
                    if (res.data.code === 0) {
                        this.list = res.data.data.list;
                        this.total = res.data.data.total;
